    ...
    if(isset($_POST['submit'])) {
		...
		if(!empty($image_name)) {
            ...
            elseif($image_size > 5000000) {
                ...
                $update = mysqli_query($conn, "UPDATE `user` SET id='$id', name='$name', password='$pass', image='$image_name', role='$role' WHERE id=$id") or die('query failed!');
            ...
            $update = mysqli_query($conn, "UPDATE `user` SET id='$id', name='$name', password='$pass', role='$role' WHERE id=$id") or die('query failed!');
