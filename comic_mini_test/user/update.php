    ...
    if(isset($_POST['submit'])) {
		...
		if(!empty($image_name)) {
            ...
            elseif($image_size > 5000000) {
                ...
                $update = mysqli_query($conn, "UPDATE `user` SET id='$user_id', name='$name', password='$pass', image='$image_name' WHERE id=$user_id") or die('query failed!');
            ...
            $update = mysqli_query($conn, "UPDATE `user` SET id='$user_id', name='$name', password='$pass' WHERE id=$user_id") or die('query failed!');
